...
public class SecondActivity extends WearableActivity implements MenuItem.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWearableNavigationDrawer.setAdapter(new YourImplementationNavigationAdapter2(this) {
            @Override
